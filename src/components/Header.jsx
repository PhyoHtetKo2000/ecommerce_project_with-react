...
const Header = () => {
  ...
  return (
    <div className={` fixed ${isActive ? " bg-white py-4 shadow-md" : " bg-none py-2"}  w-full z-10 transition-all`}>
      <div className=" container  flex justify-between  items-center px-5  mx-auto  md:px-0 relative">
        ...
        <div onClick={() => setIsOpen(!isOpen)}>
          ...
          <div className=" bg-red-600 rounded-full w-[12px] h-[12px] absolute lg:-right-1 lg:top-5 right-4 top-5
